...
Elm.AbacusTrainer = Elm.AbacusTrainer || {};
Elm.AbacusTrainer.make = function (_elm) {
   "use strict";
   _elm.AbacusTrainer = _elm.AbacusTrainer || {};
   if (_elm.AbacusTrainer.values) return _elm.AbacusTrainer.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   var _op = {};
   var shift_ball_left = function (ball) {
      return _U.update(ball,{x: ball.x - 100});
   };
   var resetBallLocation = F2(function (n,ball) {
      return _U.update(ball,{x: n * 80 + 200,y: 60});
   });
   var resetPositions = function (current_postions) {
   ...
   var update = F2(function (action,current_state) {
      ...
      {case "ClickedRefresh": return _U.update(current_state,
           {target_number_and_seed: A2($Random.generate,
           current_state.rng,
           $Basics.snd(current_state.target_number_and_seed))
           ,user_choice: 0
         ...
         case "Reset": return _U.update(current_state,
           {user_choice: 0
           ,score: 0
           ,game_was_reset: true
           ,ball_locations: resetPositions(current_state.ball_locations)
           ,correct_locations: resetPositions(current_state.ball_locations)});
         case "ClickedBall": var _p1 = _p0._0;
           return _U.eq(current_state.needs_refresh,true) ? _U.eq(_p1,
           $Basics.fst(current_state.target_number_and_seed)) ? _U.update(current_state,
           {user_choice: _p1 + 1
           ,score: current_state.score + 1
           ,correct_locations: A2($Basics._op["++"],
           A2($List.map,
           shift_ball_left,
           A2($List.take,_p1 + 1,current_state.ball_locations)),
           A2($List.drop,_p1 + 1,current_state.ball_locations))
           ,needs_refresh: false}) : _U.update(current_state,
           {user_choice: _p1 + 1
           ,score: current_state.score - 1
           ,correct_locations: resetPositions(current_state.ball_locations)}) : _U.update(current_state,
           {user_choice: _p1 + 1
           ,correct_locations: resetPositions(current_state.ball_locations)});
         case "WindowSize": return _U.update(current_state,
           {window_width: _p0._0._0,window_height: _p0._0._1});
         default: return current_state;}
   });
   var WindowSize = function (a) {
      return {ctor: "WindowSize",_0: a};
   };
   var window_size = A2($Signal.map,WindowSize,$Window.dimensions);
   var Tick = function (a) {    return {ctor: "Tick",_0: a};};
   var ClickedBall = function (a) {
      return {ctor: "ClickedBall",_0: a};
   };
   var Reset = {ctor: "Reset"};
   var score_area = F3(function (address_of_actions,
   _p2,
   current_state) {
      var _p3 = _p2;
      return A2($Svg.g,
      _U.list([$Svg$Events.onClick(A2($Signal.message,
      address_of_actions,
      Reset))]),
      _U.list([A2($Svg.rect,
              _U.list([$Svg$Attributes.x("550")
              ...
              _U.list([$Svg$Attributes.x("550")
                      ...
                      ,$Svg$Attributes.fontSize("55")
                      ,$Svg$Attributes.fill("red")]),
              _U.list([$Svg.text($Basics.toString(current_state.score))]))]));
   });
   var ClickedRefresh = {ctor: "ClickedRefresh"};
   var target_area = F3(function (address_of_actions,
   _p4,
   current_state) {
      var _p5 = _p4;
      var target_ball = $Basics.toString(1 + $Basics.fst(current_state.target_number_and_seed));
      var target_text = current_state.game_was_reset ? "Click me !" : target_ball;
      return A2($Svg.g,
      _U.list([$Svg$Events.onClick(A2($Signal.message,
      address_of_actions,
      ClickedRefresh))]),
      _U.list([A2($Svg.rect,
              ...
              _U.list([$Svg$Attributes.x("0")
                      ,$Svg$Attributes.y("160")
                      ,$Svg$Attributes.fontSize("55")]),
              _U.list([$Svg.text(target_text)]))]));
   });
   var duration = $Time.second;
   var rotateStep = 90;
   var effective_update = F2(function (action,current_state) {
      var _p6 = action;
      switch (_p6.ctor)
      {case "ClickedRefresh": var _p7 = current_state.animationState;
           if (_p7.ctor === "Nothing") {
                 return {ctor: "_Tuple2"
                        ,_0: A2(update,action,current_state)
                        ,_1: $Effects.none};
              } else {
                 return {ctor: "_Tuple2"
                        ,_0: A2(update,action,current_state)
         ...
         case "Reset": var _p8 = current_state.animationState;
           if (_p8.ctor === "Nothing") {
                 return {ctor: "_Tuple2"
                        ,_0: A2(update,action,current_state)
                        ,_1: $Effects.none};
         ...
         case "ClickedBall": var _p9 = current_state.animationState;
           if (_p9.ctor === "Nothing") {
                 return {ctor: "_Tuple2"
                        ,_0: A2(update,action,current_state)
         ...
         case "WindowSize": var _p10 = current_state.animationState;
           if (_p10.ctor === "Nothing") {
                 return {ctor: "_Tuple2",_0: current_state,_1: $Effects.none};
              } else {
                 return {ctor: "_Tuple2"
                        ,_0: A2(update,action,current_state)
                        ,_1: $Effects.none};
              }
         default: var _p12 = _p6._0;
           var newElapsedTime = function () {
              var _p11 = current_state.animationState;
              if (_p11.ctor === "Nothing") {
                    return 0;
                 } else {
                    return _p11._0.elapsedTime + (_p12 - _p11._0.prevClockTime);
                 }
           }();
           return _U.cmp(newElapsedTime,duration) > 0 ? {ctor: "_Tuple2"
                                                        ,_0: _U.update(current_state,
   ...
   var cr30 = F5(function (ball_pair,
   n,
   labelSize,
   current_state,
   address_of_actions) {
      var animoffset = toOffset(current_state.animationState);
      var angle = $Basics.toString(current_state.angle + animoffset);
      var rball = $Basics.snd(ball_pair);
      var rxpos = $Basics.toString(rball.x);
      var ypos = $Basics.toString(rball.y);
      var cball = $Basics.fst(ball_pair);
      var cxpos = $Basics.toString(cball.x);
      var x_offset = _U.eq(cball.x,
      rball.x) ? cxpos : $Basics.toString(rball.x - $Basics.round(animoffset));
      return A2($Svg.g,
      _U.list([$Svg$Attributes.transform(A2($Basics._op["++"],
              "translate( ",
              A2($Basics._op["++"],
              x_offset,
              A2($Basics._op["++"],", ",A2($Basics._op["++"],ypos," ) ")))))
              ,$Svg$Events.onClick(A2($Signal.message,
              address_of_actions,
              ClickedBall(n)))]),
      _U.list([A2($Svg.circle,
              _U.list([$Svg$Attributes.cx("")
                      ,$Svg$Attributes.cy("")
                      ,$Svg$Attributes.r("30")
              ...
              _U.list([]),
              _U.list([A2($Svg.text$,
              _U.list([$Svg$Attributes.x("")
                      ,$Svg$Attributes.y("")
                      ,$Svg$Attributes.fontSize(labelSize)]),
              _U.list([$Svg.text($Basics.toString(n + 1))]))]))]));
   });
   var ten_circles = F2(function (address_of_actions,
   current_state) {
      var ball_pairs = A3($List.map2,
      F2(function (v0,v1) {
         return {ctor: "_Tuple2",_0: v0,_1: v1};
      }),
      current_state.correct_locations,
      current_state.ball_locations);
      var labelSize = A2($Basics.max,0,30 - current_state.score);
      var cx = F2(function (n,ball_pair) {
         return A5(cr30,
         ball_pair,
         n,
         $Basics.toString(labelSize),
         current_state,
         address_of_actions);
      });
      return A2($List.indexedMap,cx,ball_pairs);
   });
   var renderGUI = F3(function (address_of_actions,
   _p14,
   current_state) {
      var _p15 = _p14;
      var _p17 = _p15._0;
      var _p16 = _p15._1;
      var boardHeight = $Basics.toString(A2($Basics.min,240,_p16));
      var boardWidth = $Basics.toString(A2($Basics.min,1200,_p17));
      return A2($Svg.svg,
      _U.list([$Svg$Attributes.width(boardWidth)
              ...
              A2($Basics._op["++"],
              boardWidth,
              A2($Basics._op["++"]," ",boardHeight))))
              ,$Svg$Attributes.fill("lightGray")]),
      $List.concat(_U.list([A2(ten_circles,
                           address_of_actions,
                           current_state)
                           ,_U.list([A3(target_area,
                           address_of_actions,
                           {ctor: "_Tuple2",_0: _p17,_1: _p16},
                           current_state)])
                           ,_U.list([A3(score_area,
                           address_of_actions,
                           {ctor: "_Tuple2",_0: _p17,_1: _p16},
                           current_state)])])));
   });
   var view = F2(function (address_of_actions,current_state) {
      var h = current_state.window_height;
      var w = current_state.window_width;
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.div,
              _U.list([]),
              _U.list([A3(renderGUI,
              address_of_actions,
              ...
              _U.list([A2($Html.li,
                      _U.list([]),
                      _U.list([$Html.text("Click in the Green square to get a new target number to click.")]))
                      ,A2($Html.li,
                      _U.list([]),
                      _U.list([$Html.text("Click on the ball with the number shown in the Green square ")]))
                      ,A2($Html.li,
                      _U.list([]),
                      _U.list([$Html.text("The light Blue square indicates your score.")]))
                      ,A2($Html.li,
                      _U.list([]),
                      _U.list([$Html.text("The numbers on the balls become smaller as you get more correct")]))
                      ,A2($Html.li,
                      _U.list([]),
                      _U.list([$Html.text("And they get bigger when you make mistakes.")]))
                      ,A2($Html.li,
                      _U.list([]),
                      _U.list([$Html.text(A2($Basics._op["++"],
                      $Basics.toString(w),
                      A2($Basics._op["++"]," X ",$Basics.toString(h))))]))]))]))]));
   });
   var initial_state = function (externalSeed) {
      return {window_height: 600
             ,window_width: 2400
             ,user_choice: 0
             ,score: 0
             ,rng: A2($Random.$int,0,9)
             ,target_number_and_seed: {ctor: "_Tuple2"
                                      ,_0: 1
                                      ,_1: $Random.initialSeed(externalSeed)}
             ,ball_locations: resetPositions(A2($List.repeat,10,{x: 0,y: 0}))
             ,correct_locations: resetPositions(A2($List.repeat,
             10,
             {x: 0,y: 0}))
             ,needs_refresh: false
             ,game_was_reset: true
   ...
   var init = function (externalSeed) {
      return {ctor: "_Tuple2"
             ,_0: initial_state(externalSeed)
             ,_1: $Effects.none};
   };
                           ...
                           return function (i) {
                              return function (j) {
                                 return function (k) {
                                    return function (l) {
                                       return function (m) {
                                          return {window_height: a
                                                 ,window_width: b
                                                 ,user_choice: c
                                                 ,score: d
                                                 ,rng: e
                                                 ,target_number_and_seed: f
                                                 ,ball_locations: g
                                                 ,correct_locations: h
                                                 ,needs_refresh: i
                                                 ,game_was_reset: j
   ...
   return _elm.AbacusTrainer.values = {_op: _op
                                      ,init: init
...
Elm.Main.make = function (_elm) {
   ...
   var _U = Elm.Native.Utils.make(_elm),
   $AbacusTrainer = Elm.AbacusTrainer.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var app = $StartApp.start({init: $AbacusTrainer.init(externalSeed)
                             ,update: $AbacusTrainer.effective_update
                             ,view: $AbacusTrainer.view
                             ,inputs: _U.list([$AbacusTrainer.window_size])});
   var main = app.html;
